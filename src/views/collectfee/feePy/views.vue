    ...
    <div v-show="!BUS.showSelectGoods">
      ...
      <div class="btn-group-container">
        ...
        <div v-if="BUS.action === 'view'">
          ...
          <el-button type="primary" icon="el-icon-view" @click="audit">{{auditMsg}}</el-button>
          ...
          <el-checkbox v-if="BUS.selectRow.status==0" v-model="checkPrint" class="ml-15"  icon="el-icon-printer">审核打印</el-checkbox>
        </div>
      </div>
