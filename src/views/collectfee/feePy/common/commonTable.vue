  ...
  <div >
    <el-form :disabled="BUS.action === 'view'">
      <el-table
        ...
        <el-table-column sortable label="品名" prop="typeName" min-width="150">
          <template slot-scope="scope">
               <span v-if="BUS.action === 'view'">
             {{scope.row.typeName}}
            </span>
        ...
        <el-table-column sortable label="规格" prop="specAll" min-width="200">
          <template slot-scope="scope">
                  <span v-if="BUS.action === 'view'">
             {{scope.row.specAll}}
            </span>
        ...
        <el-table-column sortable :label="'重量['+ tableHeader.changeStWeight+']'" min-width="120">
          <template slot-scope="scope">
            <span v-if="BUS.action === 'view'">
               {{scope.row.weight}}
             </span>
        ...
        <el-table-column sortable label="计租天数" prop="storeDay">
          <template slot-scope="scope">
            ...
            <span v-else>
              <!--<el-input v-model="scope.row.storeDay" maxlength="11" @change="scope.row.amountCalc = true"></el-input>-->
